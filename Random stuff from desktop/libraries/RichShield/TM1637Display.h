  ...
  public:
    ...
    */
    ...
    /**
       ...
       \param pos
                The position of the display. The most left position is pos = 0 and the most right position is pos = 3.
       \param character
    ...
    */
    ...
    /**
       ...
       \param pos
                The position of the display. The most left position is pos = 0 and the most right position is pos = 3.
       \param digit
                The digit or segment pattern.
    */
    void showDigitAt(uint8_t pos, uint8_t digit);

    /**
       \brief Show the specified digit on the specified position with or without a dot.
    ...
    */
    /**
      \brief shows or hides the dot in a specified position.

      \param pos
                The position of the display. The most left position is pos = 0 and the most right position is pos = 3.
      \param visible
                true to show the dot, false to hide the dot. Defaults to true
