...
const uint8_t SIGNAL_DELAY = 1; // us
...
const uint8_t DISPLAYCOMMAND_DISPLAYON  = 0b10001000 + 0x00; // 0x00 = 1/16, brightness 0x00..0x07
...
void TM1637Display::show(String str)
{
  show(str.c_str());
}
...
void TM1637Display::bitDelay()
{
  ...
  //
  // A delayMicroseconds(1) is enough or even too long on the Arduino Uno.
